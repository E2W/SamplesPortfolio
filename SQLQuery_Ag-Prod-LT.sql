...
--IDEAS to do
-- Create and populate Production_per_capita_t  Production_per_capita_kg  Area_harvested_per_capita_ha  Land_use_per_capita_m2 Fields
--     Production_t / Population
--     Land_use_ha / Population
--     Need to cater for Null values if do this, how?

--Looking at Production per capita vs Land use per capita
--Will need checking for 0 so can change to Null
--SELECT *
--FROM [Agricultural Production].[dbo].[global-food(Potatoes)]
--WHERE Production_per_capita_kg = 0
--ORDER BY 1,2 DESC

--Join tables together.

--Creating views for use in PowerBI/Tableau


--       From here to include in Portfolio Sample 
